...
nmap <silent> <leader>d <ESC>:call ToggleFindNerd()<CR>
nmap <silent> <leader>D <ESC>:NERDTreeToggle<CR>
...
nmap <silent> <leader>ta :InteroGenericType<CR>
" Insert type of expression under cursor
nmap <silent> <leader>ti :InteroTypeInsert<CR>
" GHC errors and warnings
nmap <silent> <leader>r :InteroReload<CR>
